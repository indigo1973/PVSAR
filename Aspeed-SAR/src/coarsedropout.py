...
import albumentations.augmentations.dropout.functional as ADf
...
class CoarseDropout(A.DualTransform):
    ...
    def __init__(
        ...
        super(CoarseDropout, self).__init__(p)
    ...
    def apply(
        ...
        **params
        ...
        return ADf.cutout(img, holes, fill_value)
